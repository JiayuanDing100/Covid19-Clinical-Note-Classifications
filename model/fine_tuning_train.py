...
# The name of the task to train.I'm going to name this 'covid19'.
TASK_NAME = 'covid19'
...
#print("train_examples_for_processing:", train_examples_for_processing)
...
# Here, I’m just using the default parameters.
